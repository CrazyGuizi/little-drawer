...
export const DISPATCH_COMMON_GETALLREPORTS = 'common/getAllReports'
export const DISPATCH_COMMON_DELETEREPORT = 'common/deleteReport'
export const DISPATCH_COMMON_ACCEPTREPORT = 'common/acceptReport'
